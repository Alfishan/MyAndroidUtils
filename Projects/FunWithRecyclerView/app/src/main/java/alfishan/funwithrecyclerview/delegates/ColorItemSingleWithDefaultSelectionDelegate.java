...
public class ColorItemSingleWithDefaultSelectionDelegate extends AdapterDelegate<List<Object>> {
    ...
    public ColorItemSingleWithDefaultSelectionDelegate(Context mContext, SingleItemHelper mListener) {
